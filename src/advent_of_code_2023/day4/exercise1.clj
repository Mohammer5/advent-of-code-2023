;; --- Day 4: Scratchcards --- The gondola takes you up. Strangely, though, the
;; ground doesn't seem to be coming with you; you're not climbing a mountain.
;; As the circle of Snow Island recedes below you, an entire new landmass
;; suddenly appears above you! The gondola carries you to the surface of the
;; new island and lurches into the station.
;; 
...
(ns advent-of-code-2023.day4.exercise1
...
(defn exercise1 [cards-data]
  (let [cards (parse-cards-data cards-data)]
    (->> cards
           (mapv #(get-matching-numbers (:winning-numbers %) (:have-numbers %)))
           (mapv #(count %))
           (filterv #(not= 0 %))
           (mapv dec)
           (mapv #(int (math/pow 2 %)))
...
(defn -main []
  (pprint (exercise1 ["Card   1: 82 15 37 75 85 51 99 18 17  2 |  8 17 54 14 18 99  4 85 51 49 91 15 82 24 75 25 69 61 52 58 37 87  2 22 28"
