;; --- Day 1: Trebuchet?! --- Something is wrong with global snow production,
;;
;; and you've been selected to take a look. The Elves have even given you a
;; map; on it, they've used stars to mark the top fifty locations that are
